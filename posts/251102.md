---
title: "日本語特化の入力補正ライブラリ「textfit jp」を公開しました"
date: "2025-11-02"
...
表示の統一化、データベース保存前の標準化、フォーム入力の正規化などで活用できます。
...
先述した記事でも紹介されているように、機能が限定され、入力と出力が明確なため、テストケースを整理しやすかったです。
...
また、一部テストケースをAIに生成させたことで、自分だけでは気づけなかったパターンを補完でき、“都合のいいテスト”を書きにくくなりました。
